...
(function(){
	...
	Chart.Point = Chart.Element.extend({
		...
		draw : function(){
			...
			//Highlights controller points and the line between them.
	...
	Chart.animationService = {
		...
		addAnimation: function(chartInstance, animationObject) {
			...
			// If there are no animations queued, manually kickstart a digest, for lack of a betterphp word
	...
	Chart.Type.extend({
		...
		draw : function(ease){
			...
			helpers.each(this.datasets,function(dataset){
				...
				//We can use this extra loop to calculate the controller points of this dataset also in this loop
				...
				//A little inefficient double looping, but betterphp than the line
