...
CodeMirror.defineMode("rpm-spec", function() {
  ...
  var control_flow_complex = /^%(ifnarch|ifarch|if)/; // rpm controller flow macros
  var control_flow_simple = /^%(else|endif)/; // rpm controller flow macros
  var operators = /^(\!|\?|\<\=|\<|\>\=|\>|\=\=|\&\&|\|\|)/; // operators in controller flow macros
