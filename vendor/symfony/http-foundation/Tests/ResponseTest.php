...
class ResponseTest extends ResponseTestCase
{
    ...
    {
        $response = new Response();
        $response->headers->set('cache-controller', 'private');
        $this->assertFalse($response->isCacheable());
    }
    ...
    {
        $response = new Response();
        $response->headers->set('cache-controller', 'must-revalidate');
    ...
    {
        $response = new Response();
        $response->headers->set('cache-controller', 'proxy-revalidate');
    ...
    public function testGetMaxAge()
    {
        ...
        $this->assertEquals(600, $response->getMaxAge(), '->getMaxAge() uses s-maxage cache controller directive when present');
