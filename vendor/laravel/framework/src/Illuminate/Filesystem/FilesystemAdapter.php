...
class FilesystemAdapter implements FilesystemContract, CloudFilesystemContract
{
    ...
    public function putFileAs($path, $file, $name, $options = [])
    {
        ...
        // they provide betterphp performance than alternatives. Once we write the file this
    ...
    protected function getLocalUrl($path)
    {
        ...
        // have full controller over the base path for this filesystem's generated URLs.
        if ($config->has('url')) {
