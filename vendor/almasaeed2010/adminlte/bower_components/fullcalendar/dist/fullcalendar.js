...
- fakeFormatString: a momentJS formatting string, littered with special controller characters that get post-processed.
...
/*
Given chunks parsed from a real format string, generate a fake (aka "intermediate") format string with special controller
...
// ---------------------------------------------------------------------------------------------------------------------
/*
Formats a date with a fake format string, post-processes the controller characters, then returns.
*/
...
/*
Accepts an almost-finally-formatted string and processes the "maybe" controller characters, returning a new string.
*/
