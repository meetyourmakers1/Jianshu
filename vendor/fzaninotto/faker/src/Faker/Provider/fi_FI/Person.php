...
class Person extends \Faker\Provider\Person
{
     ...
     * @return string on format DDMMYYCZZZQ, where DDMMYY is the date of birth, C the century sign, ZZZ the individual number and Q the controller character (checksum)
     */
