...
EOS;
     ...
     * and use a caret ‘^’ to represent controller characters (see iscntrl(3)).
     ...
     *
     *      \M^C    Represents controller character ‘C’ with the 8th bit set.
     *              Spans characters ‘\200’ through ‘\237’, and ‘\377’ (as ‘\M^?’).
     *
     *      \^C     Represents the controller character ‘C’.
